...
export function Template1(url){
    return(
        ...
        body {font-family: 'Muli', sans-serif;}
          ...
          <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" data-type="columns" style="padding:30px 0px;" bgcolor="#f6f6f6" data-distribution="1">
            
            
            <tbody>
              <tr role="module-content">
                <td height="100%" valign="top"><table  style="border-spacing:0; border-collapse:collapse; margin:0px 10px 0px 10px;" cellpadding="0" cellspacing="0" align="center" border="0" bgcolor="" class="column column-0">
              <tbody>
                <tr>
        ...
        <table class="wrapper" role="module" data-type="image" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="72aac1ba-9036-4a77-b9d5-9a60d9b05cba">
            <tbody>
              <tr>
                <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
                  <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;" width="29" alt="" data-proportionally-constrained="true" data-responsive="false" src="https://techreveal.vercel.app/logo.ico" height="27">
                </td>
              </tr>
            </tbody>
        </table>
          ...
          <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="948e3f3f-5214-4721-a90e-625a47b1c957" data-mc-module-version="2019-10-22">
            <tbody>
              <tr>
                <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center">
                    <span style="font-size: 43px;">Techreveal Newsletter</span>
                </div><div></div></div></td>
              </tr>
            </tbody>
          </table>
              ...
              <tr>
                <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit;">
                    <span style="font-size: 17px; margin-left:50px"> Welcome to our tech blog newsletter! We are thrilled to have you on board and appreciate your interest in staying up to date with the latest tech news, trends, and insights. Thank you for subscribing!</span>
                        <br/><span style="font-size: 17px; margin-left:20px"> As a subscriber, you will receive regular updates directly in your inbox about our newest articles, product reviews, tutorials, and much more. We strive to deliver high-quality content that educates and inspires, helping you stay informed about the ever-evolving world of technology. </span> 
                        <br/><span style="font-size: 17px; margin-left:20px"> Rest assured, you won't miss a single article. We will notify you promptly via email every time we publish something new. This way, you can easily access the latest posts and dive into the topics that interest you the most.</span>
                </div>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center;">
                      <tbody>
                        ...
                        <td align="center" bgcolor="#ffbe00" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                          <a href="${url}" style="background-color:#177C65; border:1px solid #177C65; border-color:#177C65; border-radius:0px; border-width:1px; color:#ffffff; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;" target="_blank">View Site</a>
                        </td>
                        </tr>
                      </tbody>
                    </table>
        ...
        <div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">ready to help!</span></div><div></div></div></td>
          ...
          <!-- <table border="0" cellpadding="0" cellspacing="0" class="module" data-role="module-button" data-type="button" role="module" style="table-layout:fixed;" width="100%" data-muid="d050540f-4672-4f31-80d9-b395dc08abe1.1">
            ...
            <tbody>
              <tr>
                <td style="padding:0px 0px 30px 0px;" role="module-content" bgcolor="177C65">
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <!----------------Unsubscribe-------------->
          <div data-role="module-unsubscribe" class="module" role="module" data-type="unsubscribe" style="color:#444444; font-size:12px; line-height:20px; padding:16px 16px 16px 16px; text-align:Center;" data-muid="4e838cf3-9892-4a6d-94d6-170e474d21e5"><p style="font-size:12px; line-height:20px;"><a class="Unsubscribe--unsubscribeLink" href="https://techreveal.vercel.app/" target="_blank" style="">Unsubscribe</a> - <a href="https://techreveal.vercel.app/" target="_blank" class="Unsubscribe--unsubscribePreferences" style="">Unsubscribe Preferences</a></p></div>
